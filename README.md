...
![Симулятор процессора на МТ](examples/example.png "Симулятор процессора на МТ")
...
* АЛУ, флаги, регистры, память и стек находятся на одной общей ленте машины Тьюринга
